...
import { createDataProjeto } from '../../services/utils/Util';
...
export default function ProjetoModal(props) {
    ...
    function retornarProjeto() {
        var projeto = createDataProjeto(nome, dataInicial, dataFinal);
        console.log("Projeto: " + JSON.stringify(projeto));
        props.salvarProjeto(projeto);
        props.handleClose();
    }
            ...
            <Dialog fullScreen open={props.open} onClose={props.handleClose} aria-labelledby="form-dialog-title" TransitionComponent={Transition}>
                <AppBar className={classes.appBar}>
                    <Toolbar>
                        ...
                        <Button autoFocus color="inherit" onClick={retornarProjeto}>
                            Salvar
                        </Button>
                    </Toolbar>
                </AppBar>
